...
@objc @IBDesignable public class CircleProgressView: UIView {
    ...
    @IBInspectable public var trackWidth: CGFloat = 10.0 {
        didSet { setNeedsDisplay() }
    }
    ...
    @IBInspectable public var trackBorderColor:UIColor = UIColor.whiteColor() {
        didSet { setNeedsDisplay() }
    }

    @IBInspectable public var trackBorderWidth: CGFloat = 10.0 {
        didSet { setNeedsDisplay() }
    }
